...
CONFIG += qwt
#LIBS += -L"D:/SoftWare/Qt/Qt5.14.2/5.14.2/mingw73_32/lib/" -lqwt # enable this line if qwt pri files aren't installed
    LIBS += -L"D:/SoftWare/Qt/Qt5.14.2/5.14.2/mingw73_64/lib/" -lqwt
#LIBS += -L"D:/SoftWare/Qt/Qt5.14.2/5.14.2/msvc2017/lib/" -lqwt
#LIBS += -L"D:/SoftWare/Qt/Qt5.14.2/5.14.2/msvc2017_64/lib/" -lqwt

#INCLUDEPATH += D:/SoftWare/Qt/Qt5.14.2/5.14.2/mingw73_32/include/QtQwt
    INCLUDEPATH += D:/SoftWare/Qt/Qt5.14.2/5.14.2/mingw73_64/include/QtQwt
#INCLUDEPATH += D:/SoftWare/Qt/Qt5.14.2/5.14.2/msvc2017/include/QtQwt
#INCLUDEPATH += D:/SoftWare/Qt/Qt5.14.2/5.14.2/msvc2017_64/include/QtQwt

DEFINES += PROGRAM_NAME="\\\"serialplot\\\""

DEFINES += VERSION_MAJOR=10 VERSION_MINOR=0 VERSION_PATCH=1 VERSION_STRING=\\\"10.0.1\\\"
...
SOURCES += \
    src/main.cpp \
    src/mainwindow.cpp \
    src/omitstreamreader.cpp \
    src/omitstreamreadersettings.cpp \
    src/portcontrol.cpp \
    src/plot.cpp \
    src/zoomer.cpp \
...
HEADERS += \
    src/mainwindow.h \
    src/omitstreamreadersettings.h \
    src/utils.h \
    src/portcontrol.h \
    src/byteswap.h \
    src/plot.h \
...
FORMS += \
    src/mainwindow.ui \
    src/about_dialog.ui \
    src/omitstreamreadersettings.ui \
    src/portcontrol.ui \
    src/snapshotview.ui \
    src/commandpanel.ui \
...
INCLUDEPATH += qmake/ src/ D:/SoftWare/Qt/Qt5.12.12/5.12.12/mingw73_32/include/QtQwt
